    ...
    SubShader {
        ...
        Pass {
            ...
            float4 FragmentProgram(Interpolators i) : SV_Target {
                float depth = SAMPLE_DEPTH_TEXTURE(_CameraDepthTexture, i.uv); // handle multi platforms
                ...
                unityFogFactor = saturate(unityFogFactor);
                    ...
                    if (depth > 0.9999) { // prevent fogging the skybox
                        unityFogFactor = 1;
                    }
                #endif
